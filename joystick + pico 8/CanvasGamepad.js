	...
	*/
	var colors = {
		...
		joystick:{
			...
			stick:"rgba(204,204,204,"+ opacity +")",
			ball:"rgba(255,255,255,"+ opacity +")"
		}
	}																									
				...
				if(e.type == "touchend")
				{
					...
					for(var n = 0; n < buttons_layout.length; n++)
					{
						if(touches[id].id == buttons_layout[n].name)
						{
							...
							if(buttons_layout[n].name == "y"){SimulateKeyUp(90);}
							if(buttons_layout[n].name == "x"){SimulateKeyUp(88);}
							if(buttons_layout[n].name == "a"){SimulateKeyUp(90);}
							if(buttons_layout[n].name == "b"){SimulateKeyUp(88);}
